...
//go:generate go run github.com/yihuang/go-abi/cmd -input abi.json -output gov.abi.go -external-tuples Coin=cmn.Coin,Dec=cmn.Dec,DecCoin=cmn.DecCoin -imports cmn=github.com/cosmos/evm/precompiles/common
